...
class geomelBasinAnalysisPlugin(object):
    ...
    def initGui(self):
        ...
        self.geomel1 = QAction(icon, "1. Filled DEM & Channel Network", self.iface.mainWindow())
        ...
        self.openPPoint = QAction(icon, "Add a Discharge Point", self.iface.mainWindow())
        ...
        self.geomel2 = QAction(icon, "2. Watershed, Contours, Land Cover & Curve Number", self.iface.mainWindow())
